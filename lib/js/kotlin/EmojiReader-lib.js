(function (root, factory) {
  ...
  EmojiReader.prototype.analyzeText_6bul2c$ = function (str) {
    ...
    while (tmp$.hasNext()) {
      ...
      tmp$_0.call(destination, new EmojiReader$Node(item.startIndex, length, item.isEmoji, copyToArray(item.codePoint)));
    }
    return destination;
  };
  ...
  function EmojiReader$StateMachine() {
    ...
    this.emojiModifier_0 = plus(setOf([65038, 65039, 8419]), EmojiReader$StateMachine$Companion_getInstance().ModifierTagRange);
  ...
  EmojiReader$StateMachine.prototype.isEmojiCodePoint_0 = function (codePoint) {
    return 127488 <= codePoint && codePoint <= 131071 || (9472 <= codePoint && codePoint <= 12287) || this.isSpecialSymbol_0(codePoint);
  };
  ...
  EmojiReader$StateMachine.prototype.maybeEmojiCodePoint_0 = function (codePoint) {
    return 0 <= codePoint && codePoint <= 57;
  };
  ...
  EmojiReader$Node.prototype.equals = function (other) {
    ...
    if (other == null || !((tmp$ = Kotlin.getKClassFromExpression(this)) != null ? tmp$.equals(Kotlin.getKClassFromExpression(other)) : null))
      return false;
    Kotlin.isType(tmp$_0 = other, EmojiReader$Node) ? tmp$_0 : throwCCE();
    ...
    if (this.isEmoji !== other.isEmoji)
      return false;
    if (!contentEquals(this.codePoint, other.codePoint))
      return false;
    return true;
  };
  EmojiReader$Node.prototype.hashCode = function () {
    ...
    result = (31 * result | 0) + hashCode(this.isEmoji) | 0;
    result = (31 * result | 0) + contentHashCode(this.codePoint) | 0;
    return result;
  };
  ...
  EmojiReader$Node.prototype.copy_jceyal$ = function (startIndex, length, isEmoji, codePoint) {
  ...
  EmojiReader$Node.prototype.toString = function () {
    return 'Node(startIndex=' + Kotlin.toString(this.startIndex) + (', length=' + Kotlin.toString(this.length)) + (', isEmoji=' + Kotlin.toString(this.isEmoji)) + (', codePoint=' + Kotlin.toString(this.codePoint)) + ')';
  };
  ...
  package$emoji.String_nd5v6f$ = String_2;
